...
public class DownstreamReferenceColumnMetadataRowMapper implements RowMapper<DownstreamReferenceColumnMetaData> {
    ...
    public DownstreamReferenceColumnMetaData mapRow(ResultSet rs, int rowNum) throws SQLException {
        TableNameIdentifier tableNameIdenfier = new TableNameIdentifier(rs.getString("FKTABLE_CAT"), rs.getString("FKTABLE_SCHEM"),
                rs.getString("FKTABLE_NAME"));
        DownstreamReferenceColumnMetaData result = new DownstreamReferenceColumnMetaData(rs.getString("FK_NAME"), rs.getString("PKCOLUMN_NAME"),
                tableNameIdenfier, rs.getString("FKCOLUMN_NAME"), rs.getLong("KEY_SEQ"));
        return result;
    }
