...
public class TableDubberImpl implements TableDubber {
     ...
     */
    @Override
    public void persist(Map<TableNameIdentifier, TableData> sourceTables, Map<TableNameIdentifier, Map<RowId, RowAction>> actions,
    ...
    @Override
    public void apply(Map<TableNameIdentifier, Map<RowId, RowAction>> actions, Map<TableNameIdentifier, TableData> sourceTables,
            Map<TableNameIdentifier, TableData> mirrorTables, TableDataRepository tableDataRepository,
            Function<TableNameIdentifier, TableNameIdentifier> tableIdentifierMapper) {
        List<TableData> sortedTables = sortTopological(sourceTables.values());
        for (TableData sourceTable : sortedTables) {
    ...
    @Override
    public Map<TableNameIdentifier, Map<RowId, RowAction>> determineAction(Map<TableNameIdentifier, TableData> sourceTables,
    ...
    @Override
    public Map<TableNameIdentifier, TableData> findMirrors(Map<TableNameIdentifier, TableData> sourceTables, TableDataRepository tableDataRepository,
            Function<TableNameIdentifier, TableNameIdentifier> tableIdentifierMapper) {
    ...
    @Override
    public Map<TableNameIdentifier, TableData> findTableDataAndAssociated(TableData tableDataOrigin,
    ...
    private Map<TableNameIdentifier, TableData> findDownstreamTables(TableData tableDataOrigin, Predicate<TableNameIdentifier> whiteListPredicate,
            TableDataRepository tableDataRepository, Map<TableNameIdentifier, TableData> result) {
        Map<TableNameIdentifier, TableData> currentWorkingQueue = Maps.newHashMap();
    ...
    @Override
    public List<String> getInsertStatements(TableDataRepository tableDataRepository, TableData sourceTable, TableData destinationTable,
