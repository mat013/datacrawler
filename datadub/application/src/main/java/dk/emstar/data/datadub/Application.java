...
/**
 * 
 * Use Cached metadata repository Use Row Use RowId Use different relation
 * strategy Add more rows Make your own data table? Move sql to another class
 * 
 * 
 * 
 * @author mat013
...
public class Application {
    ...
    public static class C implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            ...
            Function<TableNameIdentifier, TableNameIdentifier> sourceToMirrorMapper = o -> new TableNameIdentifier(
                    destinationTableDataRepository.getSchema(), o.getTableName());

            Predicate<TableNameIdentifier> whitelistPredicate = o -> true;

            Map<TableNameIdentifier, TableData> sourceTables = tableDubber.findTableDataAndAssociated(sourceTable, whitelistPredicate,
                    sourceTableDataRepository);
            Map<TableNameIdentifier, TableData> mirrorTables = tableDubber.findMirrors(sourceTables, destinationTableDataRepository,
                    sourceToMirrorMapper);

            RowActionSelector rowActionCategorizer = new RowActionSelector() {
                @Override
                public RowAction selectAction(Map<String, Object> sourceRow, Map<String, Object> destinationRow, TableMetadata sourceMetaData,
            ...
            Map<TableNameIdentifier, Map<RowId, RowAction>> actions = tableDubber.determineAction(sourceTables, mirrorTables, rowActionCategorizer,
                    sourceToMirrorMapper);
            ...
            for (TableData sourceTable1 : sourceTables.values()) {
                ...
                logger.info("Table inserts: {}\r\n{}", sourceTable1.getTableIdentifier(), Joiner.on("\r\n")
